...
package org.lancer.zlibrary.ui.android.error;
...
public class BugReportActivity extends Activity implements ErrorKeys {
	public void onCreate(Bundle icicle) {
		...
		reportTextView.append("SoCoolReader " + versionName + " has been crached, sorry. You can help to fix this bug by sending the report below to FBReader developers. The report will be sent by e-mail. Thank you in advance!\n\n");
		...
		findViewById(R.id.send_report).setOnClickListener(
			new View.OnClickListener() {
				public void onClick(View view) {
					...
					//TODO:my email
					sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "wangjiatc@gmail.com" });
