...
public class ZLFileImage extends ZLSingleImage {
	...
	public InputStream inputStream() {
		try {
			final InputStream stream = new SliceInputStream(myFile.getInputStream(), myOffset, myLength);
