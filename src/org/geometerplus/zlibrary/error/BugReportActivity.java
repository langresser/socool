...
package org.geometerplus.zlibrary.error;
...
public class BugReportActivity extends Activity implements ErrorKeys {
	public void onCreate(Bundle icicle) {
		...
		reportTextView.append("SCReaderActivity " + versionName + " has been crached, sorry. You can help to fix this bug by sending the report below to SCReaderActivity developers. The report will be sent by e-mail. Thank you in advance!\n\n");
		...
		findViewById(R.id.send_report).setOnClickListener(
			new View.OnClickListener() {
				public void onClick(View view) {
					...
					sendIntent.putExtra(Intent.EXTRA_SUBJECT, "SCReaderActivity " + versionName + " exception report");
