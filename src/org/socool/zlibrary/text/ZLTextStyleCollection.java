...
import org.socool.zlibrary.xml.*;
...
public class ZLTextStyleCollection {
	...
	private ZLTextStyleCollection() {
		new TextStyleReader(this).readQuietly(FBReaderApp.Instance().createResourceFile("default/styles.xml"));
	}
