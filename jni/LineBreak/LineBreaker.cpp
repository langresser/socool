...
extern "C"
void Java_org_geometerplus_zlibrary_util_LineBreaker_init(JNIEnv *env, jobject thiz) {
	init_linebreak();
}

extern "C"
void Java_org_geometerplus_zlibrary_util_LineBreaker_setLineBreaksForCharArray(JNIEnv *env, jobject thiz, jcharArray data, jint offset, jint length, jstring lang, jbyteArray breaks) {
